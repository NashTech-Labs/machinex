...
import com.knoldus.common.{Model, Trainer}
import com.knoldus.exceptions.InconsistentTrainingDataException
import com.knoldus.util.{JsonHelper, LogHelper}
import com.knoldus.util.reader.JsonReader


trait FindSTrainer extends Trainer with JsonHelper with LogHelper{
  ...
  override protected def read: List[Map[String, Any]] = {
    trainingSampleFilePath.split('.').last match {
